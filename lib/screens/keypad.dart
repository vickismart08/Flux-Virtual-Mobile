...
class _KeypadState extends State<Keypad> {
  ...
  Future<void> _call() async {
    ...
    try {
      ...
      if (result['success'] == true) {
        if (mounted) {
          _showCallingDialog(fromNumber);
        }
      } else {
        setState(() =>
            _errorMessage = result['error'] ?? 'Call failed. Try again.');
      }
    } catch (e) {
  ...
  void _showCallingDialog(String fromNumber) {
        ...
        content: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: const Icon(Icons.call, color: Colors.green, size: 40),
            ),
            const SizedBox(height: 16),
            const Text(
              'Calling...',
          ...
          Padding(
            ...
            child: GridView.count(
              ...
              children: [
                ...
                _Key(digit: '7', letters: 'PQRS', isDark: isDark, onTap: _press),
                _Key(digit: '8', letters: 'TUV',  isDark: isDark, onTap: _press),
                _Key(digit: '9', letters: 'WXYZ', isDark: isDark, onTap: _press),
                _Key(digit: '*', letters: '',     isDark: isDark, onTap: _press),
                _Key(digit: '0', letters: '+',    isDark: isDark, onTap: _press),
                _Key(digit: '#', letters: '',     isDark: isDark, onTap: _press),
              ],
            ),
          ),
